...
public class AnnotationsMatcherTest {
    ...
    private void checkToString(ClassFile classFile, final Method method, final Annotation annotation) {
        ...
        org.dessertj.classfile.attribute.Annotation annotationInfo =
                ArrayUtils.findFirst(attribute.getAnnotations(), new Predicate<org.dessertj.classfile.attribute.Annotation>() {
                    @Override
                    public boolean test(org.dessertj.classfile.attribute.Annotation annotationInfo) {
