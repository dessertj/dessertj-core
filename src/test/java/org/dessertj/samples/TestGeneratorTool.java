...
public class TestGeneratorTool {
    ...
    private final File sampleClassesDir = new File(testClassesDir, "org/dessertj/samples");
    ...
    private void generateTest(File dir) throws IOException {
        ...
        pw.println();
        pw.println("import org.dessertj.classfile.ClassFile;");
        pw.printf("import org.dessertj.samples.%s.*;%n", dir.getName());
